...
const ArqueocabAddPage = (props) => {
	...
	const validationSchema = yup.object().shape({
		...
		arqueosupervisor: yup.string().nullable().label("Arqueosupervisor"),
		arqueorealizadopor: yup.string().nullable().label("Arqueorealizadopor"),
		arqueorevisadopor: yup.string().nullable().label("Arqueorevisadopor"),
