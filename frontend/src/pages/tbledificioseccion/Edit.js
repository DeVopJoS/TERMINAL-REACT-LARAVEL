...
const TbledificioseccionEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TbledificioseccionEditPage" className="main-page">
    { (props.showHeader) && 
...
TbledificioseccionEditPage.defaultProps = {
	primaryKey: 'seccion_id',
	pageName: 'tbledificioseccion',
	apiPath: 'tbledificioseccion/edit',
	routeName: 'tbledificioseccionedit',
...
export default TbledificioseccionEditPage;
