...
import ActaentregacabEditPage from 'pages/actaentregacab/Edit';
...
const ActaentregacabViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<ActaentregacabEditPage isSubPage apiPath={`/actaentregacab/edit/${data.ae_actaid}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="ActaentregacabViewPage" className="main-page">
    { (props.showHeader) && 
...
ActaentregacabViewPage.defaultProps = {
	id: null,
	primaryKey: 'ae_actaid',
	pageName: 'actaentregacab',
	apiPath: 'actaentregacab/view',
	routeName: 'actaentregacabview',
...
export default ActaentregacabViewPage;
