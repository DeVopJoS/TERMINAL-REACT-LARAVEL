...
import TbledificionivelEditPage from 'pages/tbledificionivel/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
const TbledificionivelViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<TbledificionivelEditPage isSubPage apiPath={`/tbledificionivel/edit/${data.nivel_id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="TbledificionivelViewPage" className="main-page">
    { (props.showHeader) && 
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">Nivel Estado</div>
                                        <div className="font-bold">{ item.nivel_estado }</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
TbledificionivelViewPage.defaultProps = {
	id: null,
	primaryKey: 'nivel_id',
	pageName: 'tbledificionivel',
	apiPath: 'tbledificionivel/view',
	routeName: 'tbledificionivelview',
...
export default TbledificionivelViewPage;
