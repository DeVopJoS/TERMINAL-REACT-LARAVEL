...
export const ArqueoReporte = ({ visible, onHide, data, resumenServicios, detalleOperadores, totalRecaudacion, totalCortes }) => {
    ...
    const exportExcel = async () => {
        ...
        const headerStyle = {
            ...
            fill: { type: 'pattern', pattern: 'solid', fgColor: { argb: '616161' } },
        ...
        const infoHeaderStyle = {
            font: { bold: true },
            fill: { type: 'pattern', pattern: 'solid', fgColor: { argb: 'CCECE4' } }, 
            border: { top: { style: 'thin' }, left: { style: 'thin' }, bottom: { style: 'thin' }, right: { style: 'thin' } },
        ...
        if (diferencia === 0) {
            diferenciaFillColor = 'C6E7C6'; //"Ninguno"
        } else if (diferencia > 0) {
            diferenciaFillColor = 'CCE5FF'; //"Sobrante"
        } else {
            diferenciaFillColor = 'FFCCCC'; //"Faltante"
        }
        ...
        worksheet.getRow(obsRow+1).height = 50;
