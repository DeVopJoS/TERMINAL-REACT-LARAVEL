...
const MyPDF = ({ cabecera = {}, detalles = [] }) => {
  const totalFilasFirstOperator = 25;
  ...
  return  (<Document>
      <Page size="A3" style={styles.page}>
          ...
          <View style={styles.tablesRow}>
            ...
            <View style={styles.tableRow}>
              <View style={styles.indexCell}>
              <Text style={styles.textSmallT}>Paquete</Text>
              </View>
              <View style={styles.dataCell}>
              <Text></Text>
              </View>
              <View style={styles.dataCell}>
              <Text style={styles.textSmallT}>Rollos:</Text>
              </View>
              <View style={styles.dataCell}>
              <Text></Text>
              </View>
              <View style={styles.dataCell}>
              <Text style={styles.textSmallT}>TOTAL PHS:</Text>
              </View>
              <View style={styles.lastDataCell}>
              <Text></Text>
              </View>
            ...
            <View style={styles.tableRow}>
              <Text>ENTREGA DE PHS SOBRANTES DE 1ER TURNO A 2DO TURNO</Text>
            </View>
            <View style={styles.tableRow}>
              <View style={styles.indexCell}>
              <Text style={styles.textSmallT}>Paquete</Text>
          ...
          <View style={styles.tableContainer}>
            ...
            <View style={styles.tableRow}>
              <Text>DEVOLUCIÓN DE PHS SOBRANTES A CAJAS</Text>
            </View>
            <View style={styles.tableRow}>
              <View style={styles.indexCell}>
              <Text style={styles.textSmallT}>Paquete</Text>
